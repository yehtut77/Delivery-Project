   ...
   <!-- ---------------------------------------------End Sidebar-------------------------------------------------------------------- -->
				...
				<div class="page-inner">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item"><a href="waybillList.jsp">Receive mode  Detail  List</a></li>
						...
						<tr  ><td >
							<form action="REEDD"  method="post">
								<input  type="hidden"   value="<%=request.getParameter("rcvd_code")%>"   name="rcvd_code">
								<input  type="hidden"   value="<%=request.getParameter("company_code")%>"   name="company_code">							
								<button type="submit" class="btn btn-secondary btn-round" >Edit Receive Type</button>
							</form></td>
					...
					<% 
		PreparedStatement pre_rcvd=con.prepareStatement("Select * from  rcvdmode where rcvd_code=? and company_code=?");
		...
		ResultSet rs_rcvd = pre_rcvd.executeQuery();
		      ...
		      %>
					...
					<div class="card-title">Receive mode Details </div>
					</div>
						<div class="card-body">
							...
							<div class=" row">
								...
								<div class="col-12 col-lg-6">
                                   <div class=" row">
										...
										<div class="col-6 col-lg-3">
											<h4>
												<%=rs_rcvd.getString("company_code")%>
											</h4>
										</div>
									</div>
									...
									<div class=" row">
										<div class="col-6 col-lg-3">
											<label> Receive mode Description</label>
										</div>
										
										<div class="col-6 col-lg-3">
								
									<h4><%=rs_rcvd.getString("rcvd_description")%></h4>
								...
								<div class="col-12 col-lg-6">		
									...
									<div class=" row">
										...
										<% 
												String s="";
												if(rs_rcvd.getString("valid_code").equalsIgnoreCase("t")) 
												{
													 s="Valid";
												}else{s="Invalid";}
