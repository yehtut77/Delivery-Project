...
{%>                                                                                  
		...
		var township_code='<%=township_code%>';
		var ward_code='<%=ward_code%>';
		var street_code='<%=street_code%>';
		if(state_code!="null"  && township_code!="null"  && ward_code!="null"  && street_code!="null" ){
			
			
			
		}
		else if(street_code=="null" && ward_code=="null" && township_code=="null"){
			
			
			
			
			$('#township_check').prop("disabled", true);
			$('#ward_check').prop("disabled", true);
			$('#street_check').prop("disabled", true);
		}
		else if(street_code=="null" && ward_code=="null"){
		
			
			$('#ward_check').prop("disabled", true);
			$('#street_check').prop("disabled", true);
		}
		else if(street_code=="null"){
		...
		String township_name=null;
		String ward_name=null;
		String street_name=null;
		PreparedStatement p=conn.prepareStatement("Select* from state where state_code=?");
		p.setString(1, state_code);
		ResultSet r=p.executeQuery();
		while(r.next()){
			state_name=r.getString("state_name");
		}
		PreparedStatement p1=conn.prepareStatement("Select* from township where township_code=? AND state_code=?");
		p1.setString(1, township_code);
		p1.setString(2, state_code);
		ResultSet r1=p1.executeQuery();
		while(r1.next()){
			township_name=r1.getString("township_name");
		}
		PreparedStatement p2=conn.prepareStatement("Select* from ward where state_code=? AND township_code=?");
		p2.setString(1, state_code);
		p2.setString(2, township_code);
		ResultSet r2=p2.executeQuery();
		while(r2.next()){
			if(r2.getString("ward_code").equalsIgnoreCase(ward_code)){
				ward_name=r2.getString("ward_name");
			}
			
		}
		PreparedStatement p3=conn.prepareStatement("Select* from street where state_code=? AND township_code=?");
		p3.setString(1, state_code);
		p3.setString(2, township_code);
		ResultSet r3=p3.executeQuery();
		while(r3.next()){
			if(r3.getString("ward_code").equalsIgnoreCase(ward_code) && r3.getString("street_code").equalsIgnoreCase(street_code)){
				street_name=r3.getString("street_name");
			}
		}
	...
	<!-- 	Start  Content -->
			...
			<br>
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="staffList.jsp">Poster</a>
							</li>
							<li class="separator">
								<i class="flaticon-right-arrow"></i>
							</li>
							<li class="nav-item">
								<a href="staffAdd.jsp">Location</a>
							</li>
						</ul>
					</div>
					...
					<form action="edit_state.jsp" method="post" id="state_form" role="form">
					
					<div class="card">
					<div class="card-body">
					   <div class="form-group"><h2>Edit Data</h2></div>
					   <div class="form-group"><h3>Please Select Category that you want to edit</h3></div>
						<div class="row text-center">
						<div class="col-3"><input type="checkbox" name="check" value="state" id="state_check">&nbsp;<label>State</label></div>
						<div class="col-3"><input type="checkbox" name="check" value="township" id="township_check">&nbsp;<label>Township</label></div>
						<div class="col-3"><input type="checkbox" name="check" value="ward" id="ward_check">&nbsp;<label>Ward</label></div>
						<div class="col-3"><input type="checkbox" name="check" value="street" id="street_check">&nbsp;<label>Street</label></div>
					...
					<input type="hidden" value="<%=staff_name%>" name="user">
					<input type="hidden" value="<%=state_code%>" name="state_code">
					<input type="hidden" value="<%=township_code%>" name="township_code">
					<input type="hidden" value="<%=ward_code%>" name="ward_code">
					<input type="hidden" value="<%=street_code%>" name="street_code">
				
					
					 							 <input type="text" required value="<%=state_name%>" name="state_name" class="only_letter" id="state" disabled/>
											...
											<div class=" col-sm-6 form-group">
											 <label class="pure-material-textfield-outlined">
					 							 ...
					 							 <input type="text" required value="<%=township_name%>" name="township_name"  id="township" disabled/>
					   							<span>Township</span>
             										</label>
											</div>	
											...
											<div class=" col-sm-6 form-group">
												 <label class="pure-material-textfield-outlined">
					 							 ...
					 							 <input type="text" required value="<%=ward_name %>" name="ward_name"  id="ward" disabled/>
					   							<span>Ward</span>
             										</label>
             										<span id="desc_error" ></span>
											</div>	
											...
											<div class=" col-sm-6 form-group">
											 <label class="pure-material-textfield-outlined">
					 							 ...
					 							 <input type="text" required value="<%=street_name%>" name="street_name"  id="street" disabled/>
					   							<span>Street</span>
             										</label>
											</div>	
