						...
						<div class="info">
							<a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
								<span>
									...
									String company_code=(String)ssss.getAttribute("ccode");
			...
			<br>
					...
					<div class="row mt--2">
						<div class="col-md-12">
							...
							<div class="card">
					<div class="card-body">
					   <div class="card-title">Edit Weight Charges</div>
					</div>	
					<script>
...
<form action="save_weight.jsp" method="post" id="charges_form" role="form">
	<%
	PreparedStatement pre11=conn.prepareStatement("Select* from charges where charges_code=?");
	pre11.setString(1, data);
	ResultSet r=pre11.executeQuery();
	while(r.next()){
	%>				
					<div class="card">
<div class="card-body">		
...
<div class="form-group">   
	       ...
	       <%			
						...
						String p11=r.getString("from_state_desc");
						while(r11.next()){
						String p=r11.getString("state_name");
						if(p11.equalsIgnoreCase(p)){
						%>	
						
						<option value="<%=r11.getString("state_name") %>" about="<%=r11.getString("state_code")%>" selected><%=r11.getString("state_name") %></option>
 ...
 <% 
		...
		String ft=r.getString("from_township_desc");
		
					while(rss.next()){  
			
					String id=rss.getString("state_code")+rss.getString("township_code");
			String ft1=rss.getString("township_name");
			if(ft.equalsIgnoreCase(ft1)){
			
			%>
			<option value="<%=rss.getString("township_name") %>" id="<%=id%>" about="<%=rss.getString("state_code")%>" state="<%=id%>" selected ><%=rss.getString("township_name") %></option>
			<% }
		%>
...
<div class="form-group">   
	       ...
	       String ts=r.getString("to_state_desc");
						ResultSet result1=p.executeQuery();
						while(result1.next()){
						String ts1=result1.getString("state_name");
						if(ts.equalsIgnoreCase(ts1)){
						
						%>
						<option value="<%=result1.getString("state_name") %>" about="<%=result1.getString("state_code")%>" selected><%=result1.getString("state_name") %></option>
						<%}
						 else {%>
		...
		<div class="col-12 col-lg-6"><div class="form-group">   
	       ...
	       <%
						...
						String a=r.getString("to_township_desc");
						while(result2.next()){
						String a1=result2.getString("township_name");
						if(a.equalsIgnoreCase(a1)){
						
						%>
						<option value="<%=result2.getString("township_name") %>" about="<%=result2.getString("state_code")%>" selected><%=result2.getString("township_name")%></option>
						<%} else{%>
		...
		<div class="form-group">   
			 <label class="pure-material-textfield-outlined">
					 ...
					 <input type="hidden" id="user" value="<%=staff_name%>" name="user" />
					  <input type="text" value="<%=r.getString("from_weight")%>" onkeypress="return isNumberKey(event)" id="from_weight" name="from_weight" required />
			 ...
			 <div class="form-group">   								
					<label class="pure-material-textfield-outlined">
								<!-- <input type="text" placeholder=""  name="username"  required> -->
								 <input type="text" value="<%=r.getString("to_weight")%>" onkeypress="return isNumberKey(event)" value="" name="to_weight" id="to_weight" required />
										<span>To Weight</span>
		             </label>	
...
<div class="col-12 col-lg-6"><div class="form-group"> 
					 <label class="pure-material-textfield-outlined">
							<input type="text" value="<%=r.getString("size")%>" onkeypress="return isNumberKey(event)" id="size" name="size" required />
							<span>Size</span>
			         </label>						
			</div></div>
<div class="col-12 col-lg-6"><div class="form-group">   	 
				<label class="pure-material-textfield-outlined">	
				<input type="text" placeholder=""  value="<%=r.getString("delivery_charges")%>" onkeypress="return isNumberKey(event)" id="delivery_charges" name="delivery_charges" required>
...
<div class="col-12 col-lg-6">	<div class="form-group"> 
			 <label class="pure-material-textfield-outlined">
			<input type="text" onkeypress="return isNumberKey(event)" value="<%=r.getString("transportation_charges")%>" id="transportation_charges" name="transportation_charges" required />
	...
	<div class="form-group">   
			<label class="pure-material-textfield-outlined">	
					...
					<!-- <input type="password" placeholder="" name="cpassword"   required> -->
					 ...
					 <%String b=r.getString("u_m");
					 while(result.next()){ 
					 String b1=result.getString("u_m");
					 if(b.equalsIgnoreCase(b1)){
					 %>
					 <option value="<%=result.getString("um_code")%>" selected><%=result.getString("u_m")%></option>
					 <%}else{ %>
