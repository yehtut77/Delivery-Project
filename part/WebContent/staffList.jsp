								...
								<div class="panel-header bg-primary-gradient">
									<div class="page-inner py-5">
										<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
											<div>
												<h2 class="text-white pb-2 fw-bold">Staff Detail Lists</h2>
											
											</div>
											<div class="ml-md-auto py-2 py-md-0">
											          <a href="staffAdd.jsp"  class="btn btn-secondary btn-round">Add New  Staff</a>
											</div>
										</div>
									</div>
							</div>
					...
					<div class="row mt--2">
						<div class="col-md-12">
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title"> Staffs   information    in system</div>
									<br>
...
if(companyType.equalsIgnoreCase("main"))	pre	=con.prepareStatement("Select * from staff ");
else 
    {
        pre	=con.prepareStatement("Select * from staff where company_code=?");
		pre.setString(1, companyCode); 	
	}
			ResultSet rs_staffList=pre.executeQuery();
		
		
		      while (rs_staffList.next()) 
		      {
		...
		%>
			<tr>
					...
					<td><%=rs_staffList.getString("staff_code")%></td>												
					<td><%=rs_staffList.getString("staff_name")%></td>
					<td><%=rs_staffList.getString("parent_agent_code")%></td>													
					<td><%=rs_staffList.getString("company_code")%></td>
					<td><%=rs_staffList.getString("staff_dept")%></td>
					<td><%=rs_staffList.getString("staff_position")%></td>
					<td>
						<div class="form-button-action">
							<form action="SDDD"  method="post">
								<input  type="hidden"   value="<%=rs_staffList.getString("staff_code")%>"   name="staff_code">
								<input  type="hidden"   value="<%=rs_staffList.getString("company_code")%>"   name="company_code">
								<input  type="hidden"   value="<%=rs_staffList.getString("agent_code")%>"   name="agent_code">
