...
<div class="card">
	<div class="card-body">
			<div class="card-title">Add New Waybill Type</div>
				     </div></div>
...
<form  method="post" enctype='multipart/form-data' action="WWW" >
	...
	<div class="card-body">								
		<div class="row">
			<div class="col-12 col-lg-6">	
				...
				<select required class="browser-default custom-select"  name="payment_companycode"  id="payment_companycode" >
	...
	%>
		...
		<%}%>
				...
				<span id="company_error"></span>
 			 	 ...
 			 	 <div class="form-group">
				            <label class="pure-material-textfield-outlined">
				                  <input type="text"  name="payment_description" id="payment_description" required  oninvalid="this.setCustomValidity('Please Enter Pyment Description')"
			...
			<div class="col-12 col-lg-6">
				 	 ...
				 	 <div class="form-group">
						  <label class="pure-material-textfield-outlined">
						         <input type="text"  name="payment_code"  maxlength="2" id="payment_code" onkeypress="javascript:return noLetter(event)"  required oninvalid="this.setCustomValidity('Please Enter payment code')" oninput="setCustomValidity('')">
...
$("#payment_code").focusout(function() {
	//alert("hello");
		...
		//city_name.value = city_name;
		 $.ajax({
		    		url: "fetch_waybillAdd_paymentCode.jsp",
		    		type: 'POST',
