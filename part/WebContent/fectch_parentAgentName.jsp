...
try{
	...
	//	 Connection conn=DriverManager.getConnection("jdbc:mysql://localhost/delivery","root","root");
		...
		if (p_code.equalsIgnoreCase("0"))
		{
			agentList=agentList+agentListStartSelected+"00"+agentListMiddle+"Parent Agent"+agentListEnd;
		...
		else{   while(rs.next())
		        {
		        	...
		        	System.out.println("p_code"+p_code+"agent_code"+code);
		        	if(p_code.equalsIgnoreCase(rs.getString("agent_code")))
		        	{
