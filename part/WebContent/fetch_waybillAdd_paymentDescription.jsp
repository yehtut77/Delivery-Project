...
try{
		...
		System.out.println("payment_description="+payment_description);
		System.out.println("payment_companycode="+payment_companycode);
		
		
		
				PreparedStatement pre=connection.prepareStatement("Select * from paymentmode where company_code=? and payment_description=?");
				 
				pre.setString(1, payment_companycode); 
				pre.setString(2, payment_description);
