...
<form  action="SSS" method="post" enctype="multipart/form-data" id="myForm">							
<div class="card">
<div class="card-body">
	...
	<div class="row">
		...
		<div class="col-md-6 col-lg-12">
			...
			<div class=" col-sm-4 form-group">
				...
				<input type="text" placeholder="" class="form-control"  name="s_code"  value="####"   readonly>
		...
		<div class="form-group">   
			 <label class="pure-material-textfield-outlined">
					 <!--  <input type="text" placeholder="" name="name"   required> -->
					  <input type="text"  value="" name="name" onkeypress="javascript:return isLetter(event)" required />
...
<div class="col-12 col-lg-6">
		...
		<div class="form-group">   	 
				<label class="pure-material-textfield-outlined">	
				<input type="password" placeholder="" name="staff_password"  id="staff_password" required>
	...
	<div class="form-group">   
			<label class="pure-material-textfield-outlined">	
					<!-- <input type="password" placeholder="" name="cpassword"   required> -->
					 <input type="password" placeholder="" name="staff_cpassword" id="staff_cpassword" required />
...
<div class="col-12 col-lg-6">	
             ...
             <div class="form-group">   
				<label class="pure-material-textfield-outlined">	
					<input type="date" value="" data-date="" class="form-control"   name="staff_dob" id="staff_dob" required >					
		...
		<div class="form-group"> 
				 <label class="pure-material-textfield-outlined">
				 <input required type="text" placeholder="" value="" name="phno"  onkeypress="javascript:return isNumber(event)" />
...
<div class="col-12 col-lg-6">		
	...
	<div class="form-group"> 													
               <label class="pure-material-textfield-outlined">
						<input type="text" placeholder="" name="address1" id="address1"required>
	...
	<div class="form-group"> 													
               <label class="pure-material-textfield-outlined">
						<input type="text" placeholder="" name="address2" id="address2" >
	            ...
	            <div class="form-group"> 													
               <label class="pure-material-textfield-outlined">
						<input type="text" placeholder="" name="address3" id="address3">
	            ...
	            <div class="form-group"> 													
               <label class="pure-material-textfield-outlined">
						<input type="text" placeholder="" name="address4" id="address4" >
...
<div class="col-12 col-lg-6">
	...
	<div class="form-group"> 
	    ...
	    <label class="pure-material-textfield-outlined">
			 <input type="text" id="s_postcode"    name="s_pcode" pattern="[0-9]{8}"  required />             
...
<div class="form-group"> 
		<label class="pure-material-textfield-outlined">
			<input type="text" placeholder=""   name="edu"   required>
...
<div class="form-group"> 
	...
	<div class="form-group"> 
		<label class="pure-material-textfield-outlined">
				 <input required type="text"  value="" name="salary" onkeypress="javascript:return isNumber(event)" required />
...
<div class="form-group"> 
		<label class="pure-material-textfield-outlined">			
		<textarea placeholder="" name="cert" rows="3" class="form-control"></textarea>
...
<div class="form-group"> 
			...
			<label class="pure-material-textfield-outlined">
			<textarea placeholder="" rows="3" class="form-control" name="skill"></textarea>
			<span>Skill</span>
	    </label>
</div>
</div>
...
<div class="row">
	...
	<div class="form-group">
		<label  class="pure-material-textfield-outlined">
				<input type="text" placeholder="" name="e_c"   required>
	...
	<div class="form-group">
		<label class="pure-material-textfield-outlined">
				...
				<input type="text"  value="" placeholder="" class="form-control"   name="e_p"    onkeypress="javascript:return isNumber(event)" required/>
...
<div class="row">
	...
	<div class="form-group">
			<label class="pure-material-textfield-outlined">
							<textarea placeholder="" rows="5" class="form-control" name="remark"></textarea>
							<span>Remark</span>
			</label>
...
<div class="card-body">		
	...
	<div class="form-group">
		<label class="pure-material-textfield-outlined">			
				<input required type="text"  value="" placeholder="" name="bname"   />
...
<div class="form-group">
	<label class="pure-material-textfield-outlined">		
			<input required type="text"  value="" placeholder=""  name="busername"  />
			<span><i style="color:red; margin-top:1px; font-size:20px;">*</i>UserName</span>
	</label>
</div>		
...
<div class="form-group">
	<label class="pure-material-textfield-outlined">	 
	    <input required type="text"  name="ano"  class="creditCardText" value="" onkeypress="javascript:return isNumber(event)"  />
...
$(document).ready(function(){    	
    ...
    $(".add-row").click(function(){
    	...
    	e=e+"</select>"
         ...
         var markup ="<tr><td><input type='checkbox' name='record'></td><td><input type='text' name='record'  value='####' readonly></td><td><input required type='text' name='record' value='' ></td><td>"
