								...
								<div class="panel-header bg-primary-gradient">
									<div class="page-inner py-5">
										<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
											<div>
												<h2 class="text-white pb-2 fw-bold">Company Detail  Lists</h2>
...
{%>
											          ...
											          <a href="companyAdd.jsp"  class="btn btn-secondary btn-round" id="addnewc" disabled="disabled">Add new  Company</a><% }
else {%>  <a  class="btn btn-secondary btn-round" id="addnewc" disabled="disabled">Add new  Company</a><%} %>
											</div>
										</div>
									</div>
							</div>
					...
					<div class="row mt--2">
						<div class="col-md-12">
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title"> Company   information    in system</div>
									<br>
...
int id=0;
													...
													<%	String company_code=rs.getString("company_code");
														...
														String township=rs.getString("company_township");
														String division=rs.getString("company_division");
														String country=rs.getString("company_country");
													...
													<td><%=country %></td>
																							...
																							<!-- start  option -->
													<td>		<input type="text" value="<%=company_code%>" name="company_code" hidden="hidden" >
													
													
															<button type="submit" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Detail"  >
