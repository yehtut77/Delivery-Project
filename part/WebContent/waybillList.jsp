...
<!-- End Sidebar -->
	...
	<!-- 	Start  Content -->
								...
								<div class="panel-header bg-primary-gradient">
									<div class="page-inner py-5">
										<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
											<div>
												<h2 class="text-white pb-2 fw-bold">WayBill Detail  Lists</h2>
											
											</div>
											<div class="ml-md-auto py-2 py-md-0">
											          <a href="waybillAdd.jsp"  class="btn btn-secondary btn-round">Add New WayBill</a>
											</div>
										</div>
									</div>
							</div>
					...
					<div class="row mt--2">
						<div class="col-md-12">
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title"> WayBill   information    in system</div>
									<br>
		...
		ResultSet rs=null;		
		if(companyType.equalsIgnoreCase("main")) rs = stmt.executeQuery("Select * from paymentmode");
		else 
		{
			PreparedStatement pre=con.prepareStatement("Select* from paymentmode where company_code=?");
		...
		%>
												<tr>
													...
													<td><%=rs.getString("payment_code")%></td>

													<td><%=rs.getString("payment_description")%></td>
												...
												%>
													...
													<td>
														...
														<form action="waybillDetail.jsp"  method="post">
														  <input  type="hidden"   value="<%=rs.getString("payment_code")%>"   name="payment_code">
