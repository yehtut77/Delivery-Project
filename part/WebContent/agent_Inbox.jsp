...
try{		
		...
		Statement stmt = con.createStatement();	 
		 PreparedStatement pre_agent = con
					.prepareStatement("Select module_code,read_unread,idagent_inbox_id,sender_name,trans_date from agent_inbox where company_code=? and agent_code=? ");
	...
	String rurr=rs_agent.getString("read_unread");
				...
				<td> <div  class="fa fa-bell"></div></td>
		...
		$(document).ready(function() {
			...
			$('table tbody tr  td').on('click',function(){
					...
					var  id=$(this).closest('tr').children()[1].textContent;
				     url = 'agent_Inbox_Read.jsp?name=' + encodeURIComponent(id);
