...
String staff_code=(String)ssss.getAttribute("staffCode");
 ...
 FileOutputStream fos = new FileOutputStream(new File("/home/teamrame/jvm/apache-tomcat-9.0.12/domains/delivery.teamramen.net/ROOT/OFD/DO"+ccode+agent_code+dn+".pdf"));
File file = new File("/home/teamrame/jvm/apache-tomcat-9.0.12/domains/delivery.teamramen.net/ROOT/OFD/DO"+ccode+agent_code+dn+".pdf");
file.mkdirs();
 ...
 connection=DriverManager.getConnection("jdbc:mysql://mysql3000.mochahost.com/teamrame_delivery?useTimezone=true&serverTimezone=UTC","teamrame_yhk2","J@v@1234");
   ...
   PreparedStatement  pre3=null,pre2=null;
    ...
    pre3.setString(7,"DO"+ccode+agent_code+dn+".pdf");
