...
var cut=domain.substr(0,5);
if(cut=="http:"){
	window.location.replace("https://www.delivery.teamramen.net");
}
</script> -->
        <!-- Main Header Start -->
                            ...
                            <div class="classynav">
                                ...
                                <ul id="nav">
                                   ...
                                   <li class="drop-down"><a href="#">Login</a>
    						            <ul class="dropdown">
    						              <li><a href="Login.jsp">Agent</a></li>
    						              <li><a href="customer_Login.jsp">Customer</a></li>
    						            </ul>
						          </li> 
                                   
                                 <li><a href="pickupRequest.jsp">Pickup Request</a></li>
...
<h2 class="fs-title"><center>Customer Login</center></h2><br>
<center><img src="./img/core-img/login.jpg" width="50" height="auto"></center><br>
    ...
    <small id="emailHelp" class="form-text  text-danger">${passcode}</small>
  </div></div>
      </div>
       <div class="row">
      <div class="col-12">  
   ...
   <small id="emailHelp" class="form-text  text-danger">${uname}</small>
  </div></div>
      </div>
       <div class="row">
      <div class="col-12">  
   ...
   <small id="emailHelp" class="form-text  text-danger">${password}</small>
  </div></div>
      </div>
       
      <center><button class="button btn btn-primary" conclick="check();"> <span>Login</span></button></center>
...
function demo(){
    ...
    if(d.value=="show"){
        var f= document.getElementById('show_f').type="mail";
